...
<tr>
    <td rowspan="2" valign="bottom" class="Header1"><a href="sempediaHome.htm?action=searchObjSemp"><img src="images/sempedia.jpg" alt="" width="299" height="60" border="0" /></a></td>
    ...
    <table border="0" cellspacing="8" cellpadding="6">
      <tr>
        ...
        <td class="top-button"><a href="createClass.htm?action=classPage" class="normal-medium">Add Class</a></td>
        <td class="top-button"><a href="createObject.htm" class="normal-medium">Add Object </a></td>
      </tr>
    </table></td>
