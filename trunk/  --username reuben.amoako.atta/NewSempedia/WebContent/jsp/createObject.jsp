...
$(document).ready(function() {
			...
			$("#create-object-btn").click(
        		function() { $("#object-created-panel").toggle("slow"); }
			//	return: false;
			);
			...
			$("#save").click(
				function(){
					...
					for(var count = 0; count<len; count++){
						...
						document.predicateForm.action = "addObject.htm?action=saveObjectDetails";
    ...
    <td>
        ...
        <table width="100%" border="0" cellpadding="6" cellspacing="0" id="new-object-panel">
		          ...
		          <tr >
		            ...
		            <input type="button" class="ie6-button-button" value="+ Attach another class" />
		          ...
		          <tr>
		            ...
		            <td id="object-create-link"><label>
		              <input type="submit" class="ie6-submit-button"name="create-object-btn" id="create-object-btn" value="Create Object" />
		            </label></td>
		          </tr>
       ...
       <form method="post" name="predicateForm" action="addObject.htm?action=saveObjectDetails" onsubmit="return saveObjectValidation()"> 
        	...
        	<core:forEach var="objectsList" items="${objectsList}">
          		...
          		<tr>
            		<td colspan="3"><p>
		              ...
		              <p>
		              <input type="button" class="ie6-button-button" name="add_property" id="add-tag-btn" value="+ Add Semantic Tag" />
		              &nbsp;&nbsp;&nbsp;&nbsp;</p>
		              <table border="0" cellspacing="0" id="add-tag">
			                ...
			                <tr id="add-property">
				                  ...
				                  <td valign="top" nowrap="nowrap" ><span class="normal-small">
				                    ...
				                    <input type="button" class="ie6-button-button" name="saveNewProperty" id="newPropertySaving" value="Save" />
				                    <input type="button" class="ie6-button-button" name="cancel-add" id="cancel-add" value="Cancel" />
				                  </td>
			                </tr>
			                <tr>
								<td colspan="3">
		      	...
		      	<tr>
		            <td><input type="button" class="ie6-button-button" value="Edit Object Page"  onclick="goToImagePage('<core:out value='${objectsList.key}'/>')"/></td>
		        </tr>
		      	<tr>
					<td colspan="3" nowrap="nowrap">
							...
							<table >
								<tr>
									<td valign="bottom">
										...
										<input type="button" class="ie6-button-button" name="removeValue" id="predicateIdForAjax<core:out value="${count}"/>r" value="Remove" onClick="myRemoveForAlreadyData('predicateIdForAjax<core:out value="${count}"/>','predicateIdForAjax<core:out value="${count}"/>r','extraTextBoxForProperty<core:out value="${count}"/>');"/>
										<div style="width:390px;" id="extraTextBoxForProperty<core:out value="${count}"/>">
										</div>
									</td>
									<td align="center" valign="bottom">
										<input align="left" type="button" class="ie6-button-button" name="addMoreValues" id="newTextBox<core:out value="${count}"/>" value="Add More Values" onclick="assignNewTextBoxName('<core:out value="${predicatesList.key}"/>');"/>
					...
					<script type="text/javascript">
						$(document).ready(function() {
							...
							var addRemoveTemp = document.getElementById(removeButton);
								...
								//$("#"+addButtonTemp).fadeIn(300, function() 
											//{
												//alert("comming");
												//textFieldCounter++;
						        				//textFieldId = 'extraTextBoxForProperty'+counting+textFieldCounter;
